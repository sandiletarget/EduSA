...
urlpatterns = [
    ...
    path("<int:pk>/assessments/submissions/", views.teacher_assessment_list, name="teacher_assessment_list"),
    ...
    path("assessments/<int:assessment_id>/submissions/", views.teacher_submission_detail, name="teacher_submission_detail"),
